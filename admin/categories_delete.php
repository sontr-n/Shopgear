<?php 
    ...
    if(isset($_GET['id'])) { $category = getCategoryById($_GET['id']); }
?>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="categories.php">Nhóm sản phẩm</a>
        </li>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-edit"></i> Xóa thông tin nhóm sản phẩm</div>
        <div class="card-body">
            <form action="" method="POST">
        <div class="form-group">
        <label for="usr">Bạn có chắc chắn muốn xóa <?php echo $category['name']?> chứ?</label>
